...
import com.cose.easemob.lmc.model.TalkMsg;
...
import com.cose.easemob.lmc.tool._Global;
...
public class TalkDataServiceImpl implements TalkDataService {
	...
	public TalkNode logout(String username) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/disconnect", _Global.HTTP_METHOD_GET, null, auth,
				TalkNode.DATA_GROUP_FRIEND);
	}
	...
	public TalkNode userDrop(Long size) throws Exception {
		return service.request(_Global.URL_USER + "?limit=" + (size != null ? size : _Global.APP_PAGE_SIZE),
	...
	public TalkNode userModifyAccess(String username, Boolean access) throws Exception {
		return service.request(
				_Global.URL_USER + "/" + username + "/" + (access != null && access ? "activate" : "deactivate"),
	...
	public TalkNode userModifyPassword(String username, String password) throws Exception {
		...
		return service.request(_Global.URL_USER + "/" + username + "/password", _Global.HTTP_METHOD_PUT, param, auth,
				null);
	}
	...
	public TalkNode userList(Long size, String cursor, Long start) throws Exception {
		return service.request(_Global.URL_USER + "?" + this.page(size, cursor, start), _Global.HTTP_METHOD_GET, null,
				auth, null);
	}

	public TalkNode userLine(String username) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/status", _Global.HTTP_METHOD_GET, null, auth,
				TalkNode.DATA_MAP);
	}

	public TalkNode userGroupList(String username) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/joined_chatgroups", _Global.HTTP_METHOD_GET, null,
				auth, TalkNode.DATA_GROUP_LIST);
	}

	public TalkNode userRoomList(String username) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/joined_chatrooms", _Global.HTTP_METHOD_GET, null,
				auth, TalkNode.DATA_ROOM_LIST);
	}

	public TalkNode userMessageCount(String username) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/offline_msg_count", _Global.HTTP_METHOD_GET, null,
				auth, TalkNode.DATA_MAP);
	}

	public TalkNode userMessageLine(String username, String id) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/offline_msg_status/" + id, _Global.HTTP_METHOD_GET,
				null, auth, TalkNode.DATA_MAP);
	}

	public TalkNode friendSave(String username, String friend) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/contacts/users/" + friend,
				_Global.HTTP_METHOD_POST, null, auth, null);
	}
	...
	public TalkNode friendList(String username) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/contacts/users", _Global.HTTP_METHOD_GET, null,
				auth, TalkNode.DATA_ARRAY);
	}

	public TalkNode blockSave(String username, String[] friend) throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("usernames", friend);
		return service.request(_Global.URL_USER + "/" + username + "/blocks/users", _Global.HTTP_METHOD_POST, param,
				auth, TalkNode.DATA_ARRAY);
	}

	public TalkNode blockDrop(String username, String friend) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/blocks/users/" + friend,
				_Global.HTTP_METHOD_DELETE, null, auth, TalkNode.DATA_ARRAY);
	}

	public TalkNode blockList(String username) throws Exception {
		return service.request(_Global.URL_USER + "/" + username + "/blocks/users", _Global.HTTP_METHOD_GET, null, auth,
				TalkNode.DATA_ARRAY);
	}
	...
	public TalkNode groupDrop(String id) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id, _Global.HTTP_METHOD_DELETE, null, auth,
				TalkNode.DATA_GROUP);
	}
	...
	public TalkNode groupModify(String id, String name, String desc, Integer limit) throws Exception {
		...
		param.put("maxusers", limit);
		return service.request(_Global.URL_GROUP + "/" + id, _Global.HTTP_METHOD_PUT, param, auth,
				TalkNode.DATA_GROUP_UPDATE);
	}
	...
	public TalkNode groupModifyOwner(String id, String owner) throws Exception {
		...
		return service.request(_Global.URL_GROUP + "/" + id, _Global.HTTP_METHOD_PUT, param, auth,
				TalkNode.DATA_GROUP_OWNER);
	}

	public TalkNode groupGet(String[] id) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + this.param(id), _Global.HTTP_METHOD_GET, null, auth,
				TalkNode.DATA_GROUP_LIST_NEW);
	}

	public TalkNode groupList(Long size, String cursor, Long start) throws Exception {
		return service.request(_Global.URL_GROUP + "?" + this.page(size, cursor, start), _Global.HTTP_METHOD_GET, null,
				auth, TalkNode.DATA_GROUP_LIST);
	}

	public TalkNode groupFriendSave(String id, String friend) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id + "/users/" + friend, _Global.HTTP_METHOD_POST, null, auth,
				TalkNode.DATA_GROUP_FRIEND);
	}
	...
	public TalkNode groupFriendSave(String id, String[] friend) throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("usernames", friend);
		return service.request(_Global.URL_GROUP + "/" + id + "/users", _Global.HTTP_METHOD_POST, param, auth,
				TalkNode.DATA_GROUP_FRIEND);
	}

	public TalkNode groupFriendDrop(String id, String friend) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id + "/users/" + friend, _Global.HTTP_METHOD_DELETE, null,
				auth, TalkNode.DATA_GROUP_FRIEND);
	}

	public TalkNode groupFriendDrop(String id, String[] friend) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id + "/users/" + this.param(friend),
				_Global.HTTP_METHOD_DELETE, null, auth, TalkNode.DATA_GROUP_FRIEND_LIST);
	}

	public TalkNode groupFriendList(String id) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id + "/users", _Global.HTTP_METHOD_GET, null, auth,
				TalkNode.DATA_GROUP_LIST_MEMBER);
	}

	public TalkNode groupBlackSave(String id, String friend) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id + "/blocks/users/" + friend, _Global.HTTP_METHOD_POST, null,
				auth, TalkNode.DATA_GROUP_FRIEND);
	}
	...
	public TalkNode groupBlackSave(String id, String[] friend) throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("usernames", friend);
		return service.request(_Global.URL_GROUP + "/" + id + "/blocks/users", _Global.HTTP_METHOD_POST, param, auth,
				TalkNode.DATA_GROUP_FRIEND_LIST);
	}

	public TalkNode groupBlackDrop(String id, String friend) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id + "/blocks/users/" + friend, _Global.HTTP_METHOD_DELETE,
				null, auth, TalkNode.DATA_GROUP_FRIEND);
	}

	public TalkNode groupBlackDrop(String id, String[] friend) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id + "/blocks/users/" + this.param(friend),
				_Global.HTTP_METHOD_DELETE, null, auth, TalkNode.DATA_GROUP_FRIEND_LIST);
	}

	public TalkNode groupBlackList(String id) throws Exception {
		return service.request(_Global.URL_GROUP + "/" + id + "/blocks/users", _Global.HTTP_METHOD_GET, null, auth,
				TalkNode.DATA_ARRAY);
	}
	...
	public TalkNode messageSave(TalkMsg data) throws Exception {
		...
		return service.request(_Global.URL_MESSAGES, _Global.HTTP_METHOD_POST, param, auth, TalkNode.DATA);// 2016-8-23
	}

	public TalkNode messageList(Long size, String cursor, Long start) throws Exception {
		return service.request(_Global.URL_MESSAGES + "?" + this.page(size, cursor, start), _Global.HTTP_METHOD_GET,
				null, auth, null);
	}

	public TalkNode chatList(Long size, String cursor, Long start) throws Exception {
		return service.request(_Global.URL_CHAT + "?" + this.page(size, cursor, start), _Global.HTTP_METHOD_GET, null,
				auth, TalkNode.DATA_CHAT_LIST);
	}
	...
	public TalkNode roomModify(String id, String name, String desc, Integer limit) throws Exception {
		...
		param.put("description", desc);
		param.put("maxusers", limit);
		return service.request(_Global.URL_ROOM + "/" + id, _Global.HTTP_METHOD_PUT, param, auth,
				TalkNode.DATA_ROOM_REDO);
	}

	public TalkNode roomDrop(String id) throws Exception {
		return service.request(_Global.URL_ROOM + "/" + id, _Global.HTTP_METHOD_DELETE, null, auth,
				TalkNode.DATA_ROOM_REDO);
	}

	public TalkNode roomGet(String id) throws Exception {
		return service.request(_Global.URL_ROOM + "/" + id, _Global.HTTP_METHOD_GET, null, auth,
				TalkNode.DATA_ROOM_LIST);
	}
	...
	public TalkNode roomFriendSave(String id, String friend) throws Exception {
		return service.request(_Global.URL_ROOM + "/" + id + "/users/" + friend, _Global.HTTP_METHOD_POST, null, auth,
				TalkNode.DATA_ROOM_REDO);
	}
	...
	public TalkNode roomFriendSave(String id, String[] friend) throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("usernames", friend);
		return service.request(_Global.URL_ROOM + "/" + id + "/users", _Global.HTTP_METHOD_POST, param, auth,
				TalkNode.DATA_ROOM_REDO);
	}

	public TalkNode roomFriendDrop(String id, String friend) throws Exception {
		return service.request(_Global.URL_ROOM + "/" + id + "/users/" + friend, _Global.HTTP_METHOD_DELETE, null, auth,
				TalkNode.DATA_ROOM_REDO);
	}

	public TalkNode roomFriendDrop(String id, String[] friend) throws Exception {
		return service.request(_Global.URL_ROOM + "/" + id + "/users/" + this.param(friend), _Global.HTTP_METHOD_DELETE,
				null, auth, TalkNode.DATA_ROOM_REDO_LIST);
	}
